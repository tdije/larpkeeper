...
- run `larp repo-map . --task "..."` before broad source reading, then expand only through exact searches;
- run `larp tool-guard . --task "..."` before long logs, broad searches, or multi-agent work and obey its output limits;
